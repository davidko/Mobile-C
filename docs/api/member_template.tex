\rhead{\CClass::\MemberFunction}
\noindent
\vspace{5pt}
\rule{6.5in}{.01in}
{\Large \CClass::\MemberFunction}\index{CClass!MemberFunction}\index{MemberFunction|see{CClass}}\\
\phantomsection
\addcontentsline{toc}{subsubsection}{MemberFunction}
