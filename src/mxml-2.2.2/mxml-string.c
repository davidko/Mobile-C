...
/*
 * "$Id: mxml-string.c,v 1.1 2007/05/23 20:43:28 david_ko Exp $"
 *
             ...
             va_list    ap)		/* I - Pointer to additional arguments */
{
  ...
  */
  ...
  bytes = mxml_vsnprintf(temp, sizeof(temp), format, ap);
  ...
  */
  ...
  if ((buffer = (char*)calloc(1, bytes + 1)) != NULL)
    mxml_vsnprintf(buffer, bytes + 1, format, ap);
...
/*
 * End of "$Id: mxml-string.c,v 1.1 2007/05/23 20:43:28 david_ko Exp $".
 */
